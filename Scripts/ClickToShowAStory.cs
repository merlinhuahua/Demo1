...
public class ClickToShowAStory : MonoBehaviour
{
    ...
    {
        //先附上对应的文字
        storyText.text = mainStoryLines[mainStoryIndex];
        title1Text.text = mainStoryTitles[mainStoryIndex,0];
        title2Text.text = mainStoryTitles[mainStoryIndex,1];
        title3Text.text = mainStoryTitles[mainStoryIndex,2];
        //显示
